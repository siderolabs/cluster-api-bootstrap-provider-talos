...
const (
	...
	DataSecretAvailableReason = "DataSecretAvailable"
...
const (
	...
	// ClientConfigAvailableReason documents a suceeded client config generation process.
	//
	// NOTE: This is the only reason for ClientConfigAvailableCondition becoming true.
	ClientConfigAvailableReason = "ClientConfigAvailable"
